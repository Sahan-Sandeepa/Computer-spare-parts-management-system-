 ...
 <!--Navigation bar End--><br>
    ...
    <div id="content">
       <a href="./Userprofile.jsp"> <img src="./img/arrow-left-solid.svg" id="back"></a>  
        ...
        <div id="rightBox" >
            <h1 id="txtSign">Delete My Account</h1>
                
            <div class="input">
                <form action="Sahandelete" method="POST">
                ...
                <input type="text" id="txtName"  name="u_name" value= "<%= u_name%>" class="check"  oninvalid="this.setCustomValidity('Enter New Name')"  oninput="this.setCustomValidity('')"readonly>
                
           
                <label>NIC No-:</label>
                <input type="text" id="txtUserName" name="nic" value= "<%= nic%>" class="check"  oninvalid="this.setCustomValidity('Enter NIC')"  oninput="this.setCustomValidity('')" readonly>
                
                
                <label>Email-:</label>
                <input type="email" id="email" value= "<%= email%>" class="check" name ="email" oninvalid="this.setCustomValidity('Enter Email')"  oninput="this.setCustomValidity('')" readonly>
         
           
         
                <label>Phone No-:</label>
                <input type="number" id="PhoneNo" name="pno" value= "<%= phone%>" class="check" oninvalid="this.setCustomValidity('Enter Phone no')"  oninput="this.setCustomValidity('')" readonly>
                    ...
                    <button type="submit" id="btnSign2" >Delete Account</button>
            </form>
